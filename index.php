...
<!-- Calculator container box -->
  ...
  <div class="insta">
    <a href="#instagram"><img src="assets/insta.png" scroll="no" style="overflow: hidden; width: 65px; height: 55px"></a>
  </div>
  <div class="brow">
    <a href="#browser"><img src="assets/browser.png" scroll="no" style="overflow: hidden; width: 65px; height: 55px"></a>
  </div>
  <div class="twit">
    <a href="#twitter"><img src="assets/twitter.png" scroll="no" style="overflow: hidden; width: 65px; height: 55px"></a>
  </div>
  <div class="yt">
    <a href="#youtube"><img src="assets/youtube.png" scroll="no" style="overflow: hidden; width: 65px; height: 55px"></a>
  </div>
  <div class="copyright">
